        ...
        <div>
          <div className="flex flex-nowrap justify-between my-2 mx-3">
            <div className="w-full pr-3">
              ...
              <div>
                <div className="relative">
                  <div className="w-full whitespace-pre-wrap pb-1 font-medium font-sans text-sky-500 text-lg">
                    Software Engineer
                  </div>
                </div>
              </div>
        ...
        <div className="mb-3">
          ...
          <div className="px-3 py-2">
            <div className="flex flex-wrap flex-row gap-2">
              <span className="text-sm inline-flex font-bold border-b border-solid border-slate-500 px-2 py-1">CSS</span>
              <span className="text-sm inline-flex font-bold border-b border-solid border-slate-500 px-2 py-1">HTML</span>
            </div>
          </div>
        </div>
      </div>
